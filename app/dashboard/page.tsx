...
async function fetchFeed(type: string, country: string, search: string): Promise<OpportunityData[]> {
    ...
    <div className="max-w-2xl mx-auto px-4 py-5">
      ...
      {data?.length === 0 && (
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 text-sm">Aucune opportunité ne correspond à tes filtres.</p>
        </div>
      )}
