    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-14 bg-gray-950 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 pt-24 pb-20 text-center">
          ...
          <h1 className="font-black text-white text-5xl sm:text-7xl leading-tight mb-6">
          ...
          <div className="grid grid-cols-3 gap-4 max-w-xl mx-auto">
            {STATS.map((s) => (
              <div key={s.label} className="bg-gray-900 border border-gray-800 rounded-2xl p-4">
                <p className="text-2xl font-black text-emerald-400 mb-0.5">{s.value}</p>
      ...
      <section id="features" className="py-24 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-gray-900 text-4xl sm:text-5xl">Tout ce dont tu as besoin</h2>
          </div>
      ...
      <section id="how" className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-gray-900 text-4xl">Simple comme bonjour</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {STEPS.map((step, i) => (
              <div key={step.n} className="flex gap-4 items-start bg-gray-50 rounded-2xl p-5 border border-gray-100">
                <div className="w-10 h-10 rounded-full bg-emerald-500 text-white font-black text-sm flex items-center justify-center shrink-0">
                  {step.n}
                </div>
                <div>
      ...
      <section className="py-24 px-6 bg-gray-950">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="font-black text-white text-4xl sm:text-5xl mb-4">
