...
const FEATURES = [
  ...
  { icon: PenLine,     title: "Lettre de motivation en 10 sec", desc: "Link IA génère une lettre personnalisée en secondes. Plus de page blanche.",                          accent: "bg-violet-50 border-violet-100", iconBg: "bg-violet-100", iconColor: "#7c3aed" },
